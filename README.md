...
* **Multi-account** – Microsoft & offline profiles, one-click switch.  
* **Instance manager** – Vanilla, Forge and Fabric; pick a version and go.  
* **Mod-friendly** – drop mods or resource-packs into the folder that opens with one button.  
* **Performance** – custom JVM flags, RAM slider, automatic Java 8/17/21 download.  
* **Looks & feels native** – dark, light and more cool themes, 4 languages, no embedded browser bloat.  
...
Binaries are free to use, **do not** mirror or re-upload them—link to this page instead.
