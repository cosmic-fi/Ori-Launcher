...
// @ts-nocheck
  ...
  import Dialog from '../model/Dialog.svelte';
    ...
    $: selectedMajorVersion = $selectedMajor;
    ...
    function handleMajorVersionClick(majorVersion) {
        console.log($canLaunch)
        if(!$canLaunch){
            alertOnInstanceEdit($launchStatus);
            return;
        }
        expandedMajor = expandedMajor === majorVersion ? null : majorVersion;
    }
    ...
    <div class="instance-manager">
        ...
        <div class="instance-version-container">
            <div class="version-wrapper">
                {#each currentVersions as versionGroup}
                    <div 
                        class="version-item-main "
                        class:active-main={expandedMajor === versionGroup.name}
                    >
                        <button 
                            class="instance-variant main-item"
                            on:click={() => handleMajorVersionClick(versionGroup.name)}
                        >
                            {versionGroup.name}
                        </button>
                        <span class="seperator">|</span>
                        <div 
                            class="instance-variant-cont"
                            class:expanded={expandedMajor === versionGroup.name}
                        >
            ...
            .instance-info-container{
                ...
                .instance-type-container{
                    ...
                    .active-instance{
                        ...
                        color: var(--text-color);
                        box-shadow: inset 0 0 0 3px var(--text-color-25);
                    }
                }
                    ...
                    .version-item-main{
                        ...
                        .instance-variant-cont{
                            ...
                            button{
                                background-color: var(--base-variant-1);
                                &:hover {
                                    box-shadow: inset 0 0 0 100px var(--accent-color-10), inset 0 0 0 4px var(--accent-color-20);
                                    color: var(--text-color);
                                }
                                &:focus {
                                    color: var(--text-color);
                                    box-shadow: inset 0 0 0 100px var(--accent-color-20), inset 0 0 0 4px var(--accent-color-60);
                                }
                            }
