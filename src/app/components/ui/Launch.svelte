                ...
                <div class="-rx" use:scrollHorizontal>
                    <div class="scroll-container">
                        {#if $rssFeed.length === 0}
                            ...
                            {/each}
                        {:else}
                            {#each $rssFeed.slice(0, 4) as rss, index}
                            ...
                            {#if $rssFeed.length > 4}
                                <div class="rss-card-container view-more">
                                    <div class="thumbnail view-more-bg">
                                        <a href="https://orilauncher.cosmicfi.dev/blogs" class="view-more-text">View More</a>
                                    </div>
                                </div>
                            {/if}
                        {/if}
