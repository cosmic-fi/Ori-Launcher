            ...
            <div class="container-group">
                <div class="wrapper-group">
                    <div class="wrapper-item-group social-group">
                        <SimpleTip text={$t("mainContent.social.github")} direction="bottom"><a href="https://github.com/cosmic-fi/ori-launcher" class="social-item" aria-label={$t("social.github")}> <i class="fa-brands fa-github"></i></a></SimpleTip>
                        <SimpleTip text={$t("mainContent.social.discord")} direction="bottom"><a href="https://discord.gg/2sPdCcuwm5" class="social-item" aria-label={$t("social.discord")}> <i class="fa-brands fa-discord"></i></a></SimpleTip>
                        <SimpleTip text={$t("mainContent.social.twitter")} direction="bottom"><a href="https://x.com/cosmicxfi" class="social-item" aria-label={$t("social.twitter")}> <i class="fa-brands fa-twitter"></i></a></SimpleTip>
                    </div>
